...
/**
 * Initializes all core plugins (tools, executors, and UI renderers).
 * This decoupled architecture allows us to easily add new tools in the future
 * without modifying the core agent loop or message bubble components.
 */
