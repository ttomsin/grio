        ...
        <div className="relative border-l border-border ml-3 space-y-8">
          {events.map((event: any, i: number) => (
            <div key={i} className="relative pl-6">
              <div className="absolute -left-1.5 top-1.5 w-3 h-3 rounded-full bg-amber-500 ring-4 ring-card" />
              ...
              <h4 className="text-sm font-medium text-foreground mb-1">{event.label}</h4>
